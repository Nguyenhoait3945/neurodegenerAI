...
class MockStream(LoggerMixin):
    ...
    def __init__(self, sources: List[str] = None):
        ...
        self.topics = {
            "technology": [
                ...
                "neural networks", "computer vision", "NLP", "robotics", "automation",
                "blockchain", "cryptocurrency", "bitcoin", "ethereum", "DeFi",
                "quantum computing", "IoT", "5G", "cloud computing", "cybersecurity"
            ],
            "health": [
                "vaccine", "COVID", "pandemic", "healthcare", "medicine", "research",
                "clinical trial", "treatment", "therapy", "diagnosis", "prevention",
                "mental health", "wellness", "fitness", "nutrition", "diet",
                "exercise", "yoga", "meditation", "stress", "anxiety"
            ],
            "climate": [
                "climate change", "global warming", "carbon emissions", "renewable energy",
                "solar power", "wind energy", "sustainability", "green energy",
                "electric vehicles", "Tesla", "environment", "pollution",
                "carbon footprint", "recycling", "conservation", "biodiversity"
            ],
            "politics": [
                "election", "vote", "democracy", "government", "policy", "legislation",
                "congress", "senate", "president", "prime minister", "parliament",
                "campaign", "candidate", "political party", "reform", "protest"
            ],
            "entertainment": [
                "movie", "film", "cinema", "Netflix", "streaming", "TV show",
                "celebrity", "actor", "actress", "director", "uber", "music",
                "song", "album", "concert", "festival", "game", "gaming",
                "esports", "sports", "football", "basketball", "soccer"
            ],
            "finance": [
                "stock market", "trading", "investment", "portfolio", "crypto",
                "trading", "forex", "economy", "inflation", "recession",
                "GDP", "unemployment", "federal reserve", "interest rates",
                "real estate", "mortgage", "loan", "credit", "banking"
            ]
        }
        ...
        self.trending_keywords = [
            "AI", "climate", "crypto", "health", "tech", "innovation",
            "sustainability", "mental health", "renewable energy", "automation"
        ]
    ...
    def stream_posts(self, duration_minutes: int = 60, posts_per_minute: int = 5) -> Iterator[Dict[str, Any]]:
        """Stream mock posts for a specified duration."""
        
        self.logger.info(f"Starting mock stream for {duration_minutes} minutes at {posts_per_minute} posts/minute")
    ...
    def simulate_burst(self, topic: str, duration_minutes: int = 30) -> Iterator[Dict[str, Any]]:
...
if __name__ == "__main__":
    ...
    for i, post in enumerate(stream.stream_posts(duration_minutes=1, posts_per_minute=2)):
